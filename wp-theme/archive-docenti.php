...
<div class="container mx-auto p-4">
    <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
        <h1 class="text-2xl font-bold mb-2 md:mb-0">Personale Docente</h1>
        
        <div class="flex flex-col sm:flex-row gap-3">
            <div class="relative">
                <input type="text" placeholder="Cerca docenti..." class="pl-10 pr-4 py-2 border rounded-md w-full">
                <i class="fas fa-search absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400"></i>
            </div>
            
            <a href="<?php echo admin_url('post-new.php?post_type=docenti'); ?>" class="button inline-flex items-center justify-center">
            ...
            <table class="min-w-full">
                ...
                <tbody>
                    <?php if (have_posts()) : while (have_posts()) : the_post(); 
                        $materia = get_post_meta(get_the_ID(), '_materia', true);
                    ...
                    <?php endwhile; else : ?>
                    <tr>
                        <td colspan="6" class="text-center py-4">Nessun docente trovato</td>
                    </tr>
                    <?php endif; ?>
                </tbody>
            </table>
